...
public class SignUpPageUI {
	...
	public static final String SUBTITLE="//span[contains(@class,'%s')]";
	public static final String DYNAMIC_TEXTBOX="//input[@id='%s']";
	public static final String NEXT_BUTTON="//a[contains(@class,'btn btn-blue')]";
	...
	public static final String COUNTRY_DROPDOWN="//div[@name='countryId']";
}
