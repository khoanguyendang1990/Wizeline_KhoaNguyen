...
public class SignUpPageUI {
	...
	public static final String GENDER_DROPDOWN="//div[@placeholder='Select a gender']";
	public static final String MONTH_DROPDOWN="//div[@id='birthMonth']";
	public static final String DAY_DROPDOWN="//div[@id='birthDay']";
	public static final String YEAR_DROPDOWN="//div[@id='birthYears']";
	public static final String DROPDOWN="//ul[@class='ui-select-choices ui-select-choices-content ui-select-dropdown dropdown-menu']//span[@class='ui-select-choices-row-inner']";
